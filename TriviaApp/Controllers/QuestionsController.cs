...
namespace TriviaApp.Controllers
{
    ...
    public class QuestionsController : ControllerBase
    {
        ...
        // GET: api/Questions/5
        [HttpGet("GetQuestionsByRoomId/{roomId}")]
        public async Task<ActionResult<IEnumerable<Question>>> GetQuestionsByRoomId(int roomId)
        {
            var question = await _context.Question.Where(x => x.RoomId == roomId).ToListAsync();
