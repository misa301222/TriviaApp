...
using TriviaApp.Models.BindingModel;
using TriviaApp.Models.DTO;
    ...
    public class UserController : Controller
    {
        ...
        public async Task<object> RegisterUser([FromBody] AddUpdateRegisterUserBindingModel model)
        {
            try
            {
                ...
                var user = new AppUser() { FullName = model.FullName, Email = model.Email, UserName = model.Email, DateCreated = DateTime.Now, DateModified = DateTime.Now };
